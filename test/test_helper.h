...
static const char *g_super_resolucion_combine_encrypted = "../models/super_resolucion_combine_encrypted";
static const char *g_super_resolucion_combine = "../models/super_resolucion_combine";
